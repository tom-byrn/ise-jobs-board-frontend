...
export const Testimonal = () => {
  return (
    <div className="flex flex-row gap-x-16 px-8 pt-16">
      <div className="flex flex-row">
        <Image className="rounded-full max-h-[200px]" width={200} height={200} src={JOHN_COLLISON_PHOTO} alt="A photo of John Collison" />
        <div className="ml-4 flex flex-col font-mono">
          ...
          <span className="mt-2 text-neutral-400">John Collison</span>
          <span className="text-neutral-500">Entrepreneur, co-founder of Stripe</span>
        </div>
      </div>

      <div className="flex flex-row">
        <Image className="rounded-full max-h-[200px]" width={200} height={200} src={MIKE_MORRISSEY_PHOTO} alt="A photo of John Collison" />
        <div className="ml-4 flex flex-col font-mono">
          ...
          <span className="mt-2 text-neutral-400">Mike Morrissey</span>
          <span className="text-neutral-500">Catalyst Director, Analog Devices</span>
        </div>
      </div>
    </div>
  )
